...
*/
int addStation(bikeSharingADT bikeSharingAdt, size_t stationId, size_t docksCount);      //EFICIENTE
...
*/
size_t rentBike(bikeSharingADT bikeSharingAdt, size_t stationId, size_t dockId);     // EFICIENTE
/* Retorna la cantidad de docks ocupados en la estación con identificador stationId
** o -1 si la estación no existe
*/
size_t bikesAvailable(bikeSharingADT bikeSharingAdt, size_t stationId);       // EFICIENTE
...
*/
size_t returnBike(bikeSharingADT bikeSharingAdt, size_t stationId, size_t dockId);      // EFICIENTE
/* Retorna la cantidad de docks libres en la estación con identificador stationId o -1
** si la estación no existe.
*/
size_t docksAvailable(bikeSharingADT bikeSharingAdt, size_t stationId);       // EFICIENTE
