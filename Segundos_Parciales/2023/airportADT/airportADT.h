...
*/
int addRunway(airportADT airportAdt, size_t runwayId);     // EFICIENTE
...
*/
int addPlaneToRunway(airportADT airportAdt, size_t runwayId, const char * registration);      // EFICIENTE
...
*/
char * takeOff(airportADT airportAdt, size_t runwayId);      // EFICIENTE
